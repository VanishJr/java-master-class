...
public class Meal {
    ...
    private class Burger extends Item{
        private enum Extra {AVOCADO, ONIONS, TOMATO, BACON, KETCHUP, SALAD, CHEESE, PICKLES;
            private double getPrice() {
                return switch (this) {
                    case BACON, ONIONS, PICKLES -> 1.0;
                    case CHEESE, AVOCADO, KETCHUP, TOMATO, SALAD -> 0.5;
                    default -> 0;
                };
            }
        }
        ...
        private void addToppings(String... selectedToppings) {
            ...
            for(String selectedTopping : selectedToppings) {
                try {
                    ...
                    System.out.println(selectedTopping + " not found");
                }
            }
        }
